		...
		<main className="bg-white">
			...
			<section className="from-var-tl-primary relative overflow-hidden bg-gradient-to-r to-blue-600 px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
				...
				<div className="relative mx-auto max-w-4xl text-center">
					<h2 className="font-display mb-4 text-3xl font-bold text-white sm:text-4xl">{t('cta.title')}</h2>
					<p className="mb-8 text-base leading-relaxed text-blue-50 sm:text-lg">{t('cta.body')}</p>

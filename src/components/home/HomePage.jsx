		...
		<div className="relative isolate overflow-clip bg-white text-slate-900">
			...
			<main>
									...
									>
										...
										<div className="relative">
											...
											>
												...
												<h3
													className={`font-display min-w-0 leading-tight font-bold ${
														isActive ? 'text-[1.04rem] sm:text-lg' : 'text-[1.04rem] sm:text-lg'
													}`}
												>
													{service.title}
												</h3>
				...
				<section
					...
					className="scroll-reveal review-section bg-[#f8fbff] py-16 md:py-24"
				>
